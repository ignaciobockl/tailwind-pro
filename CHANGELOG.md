...
### Refactor
- Move skill content into `skills/tailwind-pro/` layout for CLI compatibility with `npx skills add`
- Update CI workflow paths, README structure, and references to new layout
